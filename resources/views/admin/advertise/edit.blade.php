                    ...
                    <form id="quickForm" method="POST" action="{{ Url('/admin/advertise/store') }}"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                <?= $advertise->type == 'home_lead_left_add' ? 'checked' : '' ?>
                                                type="radio" name="type" id="type_4" value="home_lead_left_add">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                <?= $advertise->type == 'home_lead_right_add' ? 'checked' : '' ?>
                                                type="radio" name="type" id="type_5" value="home_lead_right_add">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                <?= $advertise->type == 'home_middle_big_add' ? 'checked' : '' ?>
                                                type="radio" name="type" id="type_7" value="home_middle_big_add">
                                    ...
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                <?= $advertise->type == 'home_sports_right_add' ? 'checked' : '' ?>
                                                type="radio" name="type" id="type_8" value="home_sports_right_add">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                <?= $advertise->type == 'extra_add_1' ? 'checked' : '' ?> type="radio"
                                                name="type" id="type_12" value="extra_add_1">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                <?= $advertise->type == 'extra_add_2' ? 'checked' : '' ?> type="radio"
                                                name="type" id="type_13" value="extra_add_2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                <?= $advertise->type == 'extra_add_3' ? 'checked' : '' ?> type="radio"
                                                name="type" id="type_14" value="extra_add_3">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control" id="content">{!! $advertise->content !!}</textarea>
                            </div>
                            <div class="form-group">
